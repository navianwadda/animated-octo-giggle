// models/YdlModels.kt
// Shared data models for both V1 and V2.
// These map directly to what ydl_bridge.py returns as JSON.

package com.yourapp.ydl.models

import android.os.Parcelable
import kotlinx.parcelize.Parcelize

enum class FormatType {
    VIDEO_AUDIO,   // merged — needs ffmpeg
    VIDEO_ONLY,    // direct URL, no audio
    AUDIO_ONLY     // direct URL, no video
}
...
data class VideoFormat(
    ...
    val formatId: String,
    val directUrl: String?,   // null for merged formats
    val merged: Boolean,
    val filename: String,
) : Parcelable {
